...
app.post('/', async(req, res)=>{
    ...
    const prompt_1 = `i'm a ${gender} ${age} yo, ${height} m tall, ${weight} kg weight, ${FatPercentage}% fat persentage, ${MusclePercentage}% mascule mass, i do ${type.type} and my goal is ${goals.goal}, give me 2 meals afterWorkout and preWorkout that could help me rache my goals, be more specific about ingredient, and measure by gram, liter, tablespoon, cup or unit use this ingredient: ${ingredient}. and return json format like this :{'ingredient': 'banana', quantity: 1', 'measure': 'unit'}, {'ingredient': 'rice', 'quantity': 100', 'measure':'Gram'}`;
